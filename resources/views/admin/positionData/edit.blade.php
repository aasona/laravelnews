        ...
        <form action="{{url('admin/positionData')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="pcon_title" value="{{$field->pcon_title}}">
                        <span><i class="fa fa-exclamation-circle yellow"></i>标题名称必须填写</span>
                    </td>
                </tr>

                <tr>
                    <th><label for="inputname" >选择推荐位:</label></th>
                    <td>
                        <select name="pos_id">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="{{$field->pcon_thumb}}" id="art_thumb_img" style="max_witdh:350px;max-height: 100px">
                    </td>
                </tr>
                <tr>
                    <th>缩略图：</th>
                    <td>
                        ...
                        <input type="text" size="50" name="pcon_thumb" value="{{$field->pcon_thumb}}">
                            ...
                            $(function() {
                                $('#file_upload').uploadify({
                                    ...
                                    'onUploadSuccess' : function (file,data,response) {
                                        $('input[name=pcon_thumb]').val(data);
                ...
                <tr>
                    <th> Url：</th>
                    <td>
                        <input type="text" class="lg" name="pcon_url" value="{{$field->pcon_url}}">
                    </td>
                </tr>
                <tr>
                    <th>文章id：</th>
                    <td>
                        <input type="text" class="sm" name="art_id" value="{{$field->art_id}}">
                    </td>
                </tr>
                <tr>
                    <th></th>
