        ...
        <form action="{{url('admin/article/'.$field->art_id)}}" method="post">
            ...
            <table class="add_tab">
                    ...
                    <td>
                        <select name="cate_id">
                            @foreach($data as $d)
                                ...
                                @if($field->cate_id == $d->cate_id) selected @endif>{{$d->_cate_name}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <th></th>
                    <td>
                        <img id="art_thumb_img" style="max_witdh:350px;max-height: 100px" src="{{$field->art_thumb}}">
                    </td>
                </tr>
                <tr>
                    <th>缩略图：</th>
                ...
                <td>
                    ...
                    <script type="text/javascript" charset="utf-8" src="{{asset('news/org/ueditor/ueditor.config.js')}}"></script>
                    <script type="text/javascript" charset="utf-8" src="{{asset('news/org/ueditor/ueditor.all.min.js')}}"> </script>
                    <script type="text/javascript" charset="utf-8" src="{{asset('news/org/ueditor/lang/zh-cn/zh-cn.js')}}"></script>
                    <script id="editor" name="art_content" type="text/plain" style="width:860px;height:400px;">{!! $fieldCon !!}</script>
                    <script type="text/javascript">
